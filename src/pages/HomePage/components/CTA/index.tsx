...
export const CTA: React.FC = () => {
  ...
  return (
    <S.Wrapper>
      <S.Description>{token ? HomePageWordings.connected_description : HomePageWordings.description}</S.Description>
      <S.ButtonDogIconWrapper>
        {token ? 
        <Button>
          <S.ButtonLink to='gardens'>{HomePageWordings.connected_cta}</S.ButtonLink> 
        </Button> : 
